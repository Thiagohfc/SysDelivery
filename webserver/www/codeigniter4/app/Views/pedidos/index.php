        ...
        <div class="container">
            ...
            <table class="table">
                ...
                <tbody class="table-group-divider">
                    ...
                    <tr>
                        <td><?= $item->produtos_nome ?></td>
                        <td><?= date('d/m/Y H:i', strtotime($item->data_pedido)) ?></td>
                        <td><?= ucfirst($item->status) ?></td>
                        <td>R$ <?= number_format($item->total_pedido, 2, ',', '.') ?></td>
                        <td>
                            <a class="btn btn-primary" href="<?= base_url('pedidos/edit/' . $item->pedidos_id); ?>">
                                Editar <i class="bi bi-pencil-square"></i>
                            </a>
                            <a class="btn btn-danger" href="<?= base_url('pedidos/delete/' . $item->pedidos_id); ?>">
                                Excluir <i class="bi bi-x-circle"></i>
                            </a>
                        </td>
                    </tr>

                        ...
                        <div class="row mb-2 produto-item">
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="quantidades[]" class="form-control text-center quantidade" value="1" min="1" required>
                        ...
                        <?php foreach ($itensPedido as $item): ?>
                            <div class="row mb-2 produto-item">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <button type="button" class="btn btn-outline-secondary btn-minus">-</button>
                                        <input type="number" name="quantidades[]" class="form-control text-center quantidade" value="<?= $item->quantidade ?>" min="1" required>
                                        <button type="button" class="btn btn-outline-secondary btn-plus">+</button>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="d-flex justify-content-between align-items-center gap-3">
                                        <input type="text" class="form-control preco-final" value="R$ <?= number_format($item->produtos_preco_venda * $item->quantidade, 2, ',', '.') ?>" readonly>
                                        <button type="button" class="btn btn-danger btn-remove">Remover</button>
                                    </div>
                                </div>
                            </div>
